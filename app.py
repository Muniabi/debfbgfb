...
#         # Основные цвета
#         self.primary_bg = "#FFFFFF"  # Белый фон
#         self.secondary_bg = "#BFD6F6"  # Голубой фон
#         self.accent_color = "#405C73"  # Темно-синий акцент
#         self.text_color = "#333333"  # Темно-серый текст
        
#         # Настройка основного окна
#         self.setWindowTitle("Система управления производством")
#         self.setWindowIcon(QIcon('icon.png'))  # Укажите путь к вашей иконке
...
#     # Установка шрифта для всего приложения
#     font = QFont()
#     font.setFamily("Segoe UI")  # Или другой современный шрифт
#     font.setPointSize(10)
#     app.setFont(font)
